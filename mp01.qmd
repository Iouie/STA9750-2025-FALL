...
[](docs/mp01_files/figure-html/unnamed-chunk-15-1.png)
...
```
[](docs/mp01_files/figure-html/unnamed-chunk-16-1.png)
```{r}
...
ggplot(world_map) +
  ...
  guides(fill = "none")
```
[](docs/mp01_files/figure-html/unnamed-chunk-17-1.png)
...
```
[](docs/mp01_files/figure-html/unnamed-chunk-18-1.png)
```{r}
#| include: false
1+1
```
