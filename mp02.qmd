...
* There are many different states with high Rate Scores, with Florida, Texas, and North Carolina Metro Areas having multiple entries in the top 10. On the other hand, Illinois, West Virginia, and Arkansas Metro Areas have some of the lowest Rate Scores.
## Composite Score
```{r}
